...
export function PhaseDevelopment() {
  const { ref, isIntersecting: isInView } = useIntersectionObserver({ threshold: 0.3 });

  return (
    <section className="min-h-screen flex items-center py-20 bg-muted/30" ref={ref}>
      <div className="container-width">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          {/* Visual - Now on the left */}
          <div className={`
          ...
          `}>
            <div className="space-y-4">
              ...
              <h2 className="text-4xl lg:text-5xl font-bold">Development</h2>
              <p className="text-xl text-muted-foreground">6-12 weeks</p>
              <p className="text-lg">Building your solution with precision and care</p>
            </div>
